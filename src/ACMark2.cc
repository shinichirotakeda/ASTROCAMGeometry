...
G4LogicalVolume* ACMark2::Construct() {
  ...
  for (int i = 0; i < 16; i++) {
    ...
    if(i==8||i==9||i==10||i==11||i==12||i==13||i==14||i==15) new G4PVPlacement(0, G4ThreeVector(SiModule_xPos, SiModule_yPos, SiModule_zPos), SiModule_Logical, name, ComptonCamera_Logical, false, i, surfaceCheck);
  }
  // Plate /////////////////////////////

...
G4LogicalVolume* ACMark5::Construct() {
  ...
  for (int i = 0; i < 16; i++) {
    ...
    new G4PVPlacement(0, G4ThreeVector(SiModule_xPos, SiModule_yPos, SiModule_zPos), SiModule_Logical, name, ComptonCamera_Logical, false, i, surfaceCheck);
  }
  // Plate /////////////////////////////
